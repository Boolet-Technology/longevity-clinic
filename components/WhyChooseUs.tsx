        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <FadeInLeft className="relative">
            <div className="relative">
              ...
              >
                ...
                <span className="text-accent-foreground/80 text-sm font-body">Years of Excellence</span>
              </motion.div>
            </div>
          </FadeInLeft>
          ...
          <FadeInRight>
            ...
            <h2 className="font-heading text-3xl md:text-5xl text-primary-foreground mt-4 mb-6 leading-tight">
              A Legacy of
              <br />
              <span className="text-accent italic">Medical Excellence</span>
            </h2>
            <p className="text-primary-foreground/70 font-body leading-relaxed mb-8">
              At UK Longevity Clinic, we combine decades of medical expertise with 
              cutting-edge technology to deliver unparalleled results. Our commitment 
              to excellence is reflected in every aspect of your journey with us.
            </p>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div>
                <span className="block text-primary-foreground font-heading text-lg">50+ Specialists</span>
                <span className="text-primary-foreground/60 text-sm font-body">World-class medical team</span>
              </div>
            </div>
          </FadeInRight>
        </div>
